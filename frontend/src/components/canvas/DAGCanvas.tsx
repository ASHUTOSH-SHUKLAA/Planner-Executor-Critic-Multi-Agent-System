...
export function DAGCanvas({ steps, selectedStepId, onSelectStep }: DAGCanvasProps) {
      ...
      if (step.depends_on && step.depends_on.length > 0) {
        step.depends_on.forEach((parent) => {
          ...
          computedEdges.push({
            ...
            style: {
              stroke: isParentPassed ? "#10b981" : isTargetExecuting ? "#38bdf8" : "#475569",
              strokeWidth: 2,
            },
            markerEnd: {
              ...
              width: 14,
              height: 14,
              color: isParentPassed ? "#10b981" : isTargetExecuting ? "#38bdf8" : "#475569",
            },
          });
        });
      }
  ...
  if (steps.length === 0) {
    return (
      <div className="h-full w-full flex flex-col items-center justify-center border border-zinc-800/80 rounded-2xl bg-zinc-950/40 p-8 text-center">
        ...
        <h4 className="text-base font-semibold text-white">Dynamic Execution DAG Canvas</h4>
  ...
  return (
    <div className="h-full w-full rounded-2xl border border-zinc-800 bg-zinc-950/60 overflow-hidden relative">
      <ReactFlow
        nodes={nodes}
        edges={edges}
        nodeTypes={nodeTypes}
      ...
      >
        ...
        <MiniMap
          ...
          className="!bg-zinc-950/90 !border-zinc-800 rounded-lg overflow-hidden"
