"""
Groq LLM Provider (Legacy / Fallback Provider).
Allows backward-compatible execution if GROQ_API_KEY is configured.
"""
...
class GroqProvider(BaseLLMProvider):
    """Groq Provider implementing BaseLLMProvider."""
    ...
    def __init__(
        ...
        if not self.api_key:
            raise ValueError(
                "GROQ_API_KEY is not set. Please set GROQ_API_KEY in .env."
            )
